...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Rainbow Sprinkles",0.01,new ArrayList<>(Arrays.asList("red #5", "yellow #6", "blue #4")));
        Topping topping2 = new Topping("Whipped Cream",0.10,new ArrayList<>(Arrays.asList("dairy")));
        Topping topping3 = new Topping("Gummy Bear",0.05,new ArrayList<>(Arrays.asList("red #5", "yellow #6", "blue #4", "gelatin")));
        Topping topping4 = new Topping("Peanuts",0.50,new ArrayList<>(Arrays.asList("nuts")));
        Topping topping5 = new Topping("Strawberry Sauce",0.01,new ArrayList<>(Arrays.asList("strawberries", "gelatin")));
