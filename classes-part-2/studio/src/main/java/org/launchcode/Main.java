...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(openingDayMenu.getLastUpdated());
        ...
        MenuItem coffee = new MenuItem("French Press Coffee",1.99,"Coffee servered with sugar and cream","Beverage");
        ...
        System.out.println(weekendMenu1.getLastUpdated());
